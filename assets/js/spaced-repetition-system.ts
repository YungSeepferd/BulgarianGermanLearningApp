...
if (document.readyState === 'loading') {
  document.addEventListener('DOMContentLoaded', () => {
    (window as unknown as { phaseCalculator: PhaseCalculator }).phaseCalculator = new PhaseCalculator();
    (window as unknown as { unifiedSpacedRepetition: UnifiedSpacedRepetition }).unifiedSpacedRepetition = new UnifiedSpacedRepetition(
      (window as unknown as { phaseCalculator: PhaseCalculator }).phaseCalculator,
      (window as unknown as { profileManager: ProfileManager }).profileManager // Pass profileManager for data isolation
    );
