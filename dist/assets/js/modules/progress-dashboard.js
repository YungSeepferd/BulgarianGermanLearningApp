...
export class ProgressDashboard {
    ...
    renderPhaseChart() {
        ...
        if (window.Chart) {
            ...
            this.renderSimplePhaseChart(ctx, data);
        }
    }
    /**
    ...
    renderDirectionChart() {
        ...
        if (window.Chart) {
            ...
            this.renderSimpleDirectionChart(ctx, stats);
        }
    }
    /**
    ...
    renderCategoryChart() {
        ...
        if (window.Chart) {
            ...
            this.renderSimpleCategoryChart(ctx, stats, sortedCategories);
        }
    }
    /**
    ...
    renderActivityChart() {
        ...
        if (window.Chart) {
            ...
            this.renderSimpleActivityChart(ctx, activityData);
        }
    }
    /**
     ...
     */
    renderSimplePhaseChart(container, data) {
     ...
     */
    renderSimpleDirectionChart(container, stats) {
        const directions = [
     ...
     */
    renderSimpleCategoryChart(container, _stats, categories) {
     ...
     */
    renderSimpleActivityChart(container, activityData) {
