...
window.BgDeApp.initVocabulary = function () {
...
window.BgDeApp.loadVocabularyData = function () {
...
window.BgDeApp.bindVocabularyEvents = function () {
    // Filter controls
...
window.BgDeApp.bindCardSelectionEvents = function () {
    document.addEventListener('click', function (e) {
        const target = e.target;
        // Handle card selection
        if (target.classList.contains('vocabulary-card') || target.closest('.vocabulary-card')) {
            const card = target.classList.contains('vocabulary-card') ? target : target.closest('.vocabulary-card');
        ...
        if (target.classList.contains('flip-btn') || target.closest('.flip-btn')) {
            e.preventDefault();
            const card = target.closest('.vocabulary-card');
            if (card) {
...
window.BgDeApp.applyVocabularyFilters = function () {
    window.BgDeApp.vocabulary.filteredData = window.BgDeApp.vocabulary.data.filter(function (item) {
        // Level filter
...
// Clear all filters
window.BgDeApp.clearAllVocabularyFilters = function () {
...
window.BgDeApp.renderVocabulary = function () {
    ...
    container.innerHTML = window.BgDeApp.vocabulary.filteredData.map(function (item) {
...
window.BgDeApp.updateVocabularyStats = function () {
...
window.BgDeApp.toggleWordSelection = function (word, cardElement) {
...
window.BgDeApp.flipVocabularyCard = function (cardElement) {
...
window.BgDeApp.startPracticeWithSelected = function () {
...
window.BgDeApp.shuffleArray = function (array) {
