 ...
 */
export type { VocabularyItem, PracticeSession } from '$lib/schemas/vocabulary.js';
export type { PracticeStat, UserProgressStorage, ExportedUserData } from '$lib/schemas/localStorage.js';
