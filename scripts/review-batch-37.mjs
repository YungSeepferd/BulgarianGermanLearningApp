...
console.log('🔍 Batch 37 Linguistic Review (Entries 1801-1850)');
console.log('=================================================\n');

let issuesFound = 0;

// Review entries 1801-1850 (0-indexed: 1800-1849)
const batchEntries = vocabulary.items.slice(1800, 1850);

batchEntries.forEach((entry, index) => {
    const entryNum = 1801 + index;
    let hasIssues = false;
    let issueDetails = [];
