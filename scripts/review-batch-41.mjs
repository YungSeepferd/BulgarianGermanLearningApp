...
console.log('🔍 Batch 41 Linguistic Review (Entries 2001-2050)');
console.log('=================================================\n');

let issuesFound = 0;

// Review entries 2001-2050 (0-indexed: 2000-2049)
const batchEntries = vocabulary.items.slice(2000, 2050);

batchEntries.forEach((entry, index) => {
    const entryNum = 2001 + index;
    let hasIssues = false;
    let issueDetails = [];
