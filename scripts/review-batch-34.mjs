...
console.log('🔍 Batch 34 Linguistic Review (Entries 1651-1700)');
console.log('=================================================\n');

let issuesFound = 0;

// Review entries 1651-1700 (0-indexed: 1650-1699)
const batchEntries = vocabulary.items.slice(1650, 1700);

batchEntries.forEach((entry, index) => {
    const entryNum = 1651 + index;
    let hasIssues = false;
    let issueDetails = [];
