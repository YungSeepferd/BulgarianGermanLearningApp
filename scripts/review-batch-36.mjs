...
console.log('🔍 Batch 36 Linguistic Review (Entries 1751-1800)');
console.log('=================================================\n');

let issuesFound = 0;

// Review entries 1751-1800 (0-indexed: 1750-1799)
const batchEntries = vocabulary.items.slice(1750, 1800);

batchEntries.forEach((entry, index) => {
    const entryNum = 1751 + index;
    let hasIssues = false;
    let issueDetails = [];
