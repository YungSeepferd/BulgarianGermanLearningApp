...
console.log('🔍 Batch 42 Linguistic Review (Entries 2051-2100)');
console.log('=================================================\n');

let issuesFound = 0;

// Review entries 2051-2100 (0-indexed: 2050-2099)
const batchEntries = vocabulary.items.slice(2050, 2100);

batchEntries.forEach((entry, index) => {
    const entryNum = 2051 + index;
    let hasIssues = false;
    let issueDetails = [];
