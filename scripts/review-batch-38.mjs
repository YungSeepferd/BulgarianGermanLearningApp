...
console.log('🔍 Batch 38 Linguistic Review (Entries 1851-1900)');
console.log('=================================================\n');

let issuesFound = 0;

// Review entries 1851-1900 (0-indexed: 1850-1899)
const batchEntries = vocabulary.items.slice(1850, 1900);

batchEntries.forEach((entry, index) => {
    const entryNum = 1851 + index;
    let hasIssues = false;
    let issueDetails = [];
