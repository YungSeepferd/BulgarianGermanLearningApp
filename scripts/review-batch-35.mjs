...
console.log('🔍 Batch 35 Linguistic Review (Entries 1701-1750)');
console.log('=================================================\n');

let issuesFound = 0;

// Review entries 1701-1750 (0-indexed: 1700-1749)
const batchEntries = vocabulary.items.slice(1700, 1750);

batchEntries.forEach((entry, index) => {
    const entryNum = 1701 + index;
    let hasIssues = false;
    let issueDetails = [];
