...
console.log('🔍 Batch 31 Linguistic Review (Entries 1501-1550)');
console.log('=================================================\n');

let issuesFound = 0;

// Review entries 1501-1550 (0-indexed: 1500-1549)
const batchEntries = vocabulary.items.slice(1500, 1550);
