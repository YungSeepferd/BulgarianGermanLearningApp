...
console.log('🔍 Batch 40 Linguistic Review (Entries 1951-2000)');
console.log('=================================================\n');

let issuesFound = 0;

// Review entries 1951-2000 (0-indexed: 1950-1999)
const batchEntries = vocabulary.items.slice(1950, 2000);

batchEntries.forEach((entry, index) => {
    const entryNum = 1951 + index;
    let hasIssues = false;
    let issueDetails = [];
