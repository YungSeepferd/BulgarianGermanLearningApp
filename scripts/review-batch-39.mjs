...
console.log('🔍 Batch 39 Linguistic Review (Entries 1901-1950)');
console.log('=================================================\n');

let issuesFound = 0;

// Review entries 1901-1950 (0-indexed: 1900-1949)
const batchEntries = vocabulary.items.slice(1900, 1950);

batchEntries.forEach((entry, index) => {
    const entryNum = 1901 + index;
    let hasIssues = false;
    let issueDetails = [];
