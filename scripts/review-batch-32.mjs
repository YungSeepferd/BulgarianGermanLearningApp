...
console.log('🔍 Batch 32 Linguistic Review (Entries 1551-1600)');
console.log('=================================================\n');

let issuesFound = 0;

// Review entries 1551-1600 (0-indexed: 1550-1599)
const batchEntries = vocabulary.items.slice(1550, 1600);

batchEntries.forEach((entry, index) => {
    const entryNum = 1551 + index;
    let hasIssues = false;
    let issueDetails = [];
